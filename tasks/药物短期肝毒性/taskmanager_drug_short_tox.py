...
from tasks.药物短期肝毒性.models.model_logistic_regression import LogisiticRegression, LogisiticRegressionDataProcessor
from config import *

class task_manager_drug_shot_tox(abstract_task_manager):
    def __init__(self, task_name) -> None:
        self.supported_instruction = ["模型推理"]
        self.supported_model = [
            "药物短期肝毒性_逻辑回归_20241126_1.pkl"
        ]
        super().__init__(task_name)
        self.model_mapping = {
            "药物短期肝毒性_逻辑回归_20241126_1.pkl"  : (LogisiticRegression, LogisiticRegressionDataProcessor)
        }
